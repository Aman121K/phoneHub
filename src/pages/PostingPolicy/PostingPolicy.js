        ...
        <div className="policy-content">
          ...
          <section className="policy-section">
            ...
            <div className="policy-item">
              ...
              <ul>
                <li><strong>Accurate Title:</strong> Clear description of the iPhone model and key features</li>
            ...
            <div className="policy-item">
              ...
              <ul>
                ...
                <li>Include front, back, and sides of the iPhone</li>
          ...
          <section className="policy-section">
            ...
            <div className="policy-item">
              ...
              <ul>
                ...
                <li>PhoneHub may remove listings that violate policies</li>
          ...
          <section className="policy-section">
            ...
            <p>
              PhoneHub reserves the right to remove any listing that violates our policies or 
