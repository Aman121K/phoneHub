      ...
      <div className="policy-container">
        <div className="policy-content">
          <section className="policy-section">
            ...
            <p>
              By accessing and using PhoneHub, you accept and agree to be bound by the terms and 
          ...
          <section className="policy-section">
            ...
            <p>
              PhoneHub is an online marketplace platform that connects buyers and sellers of iPhones. 
              We provide a platform for users to list, browse, and transact iPhone devices. PhoneHub 
          ...
          <section className="policy-section">
            ...
            <div className="policy-item">
              ...
              <p>
                To use certain features of PhoneHub, you must create an account. You agree to:
              </p>
              <ul>
          ...
          <section className="policy-section">
            ...
            <div className="policy-item">
              ...
              <ul>
                ...
                <li>Counterfeit or replica iPhones</li>
          ...
          <section className="policy-section">
            ...
            <p>
              When purchasing items on PhoneHub:
            </p>
            <ul>
              <li>You are entering into a contract directly with the seller</li>
              <li>PhoneHub is not a party to the transaction</li>
              ...
              <li>PhoneHub does not process payments or handle disputes directly</li>
            </ul>
          </section>
          ...
          <section className="policy-section">
            ...
            <p>
              All content on PhoneHub, including text, graphics, logos, and software, is the property 
              of PhoneHub or its content suppliers. You may not reproduce, distribute, or create 
          ...
          <section className="policy-section">
            ...
            <p>
              PhoneHub provides the platform "as is" without warranties. We are not responsible for:
            </p>
            <ul>
          ...
          <section className="policy-section">
            ...
            <p>
              PhoneHub reserves the right to suspend or terminate accounts that violate these terms, 
