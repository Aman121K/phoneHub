        ...
        <div className="policy-content">
          ...
          <section className="policy-section">
            ...
            <div className="policy-item">
              ...
              <p>
                PhoneHub may cancel auctions that violate our policies, contain fraudulent 
          ...
          <section className="policy-section">
            ...
            <div className="policy-item">
              ...
              <ul>
                <li>Seller may report the issue to PhoneHub</li>
            ...
            <div className="policy-item">
              ...
              <ul>
                ...
                <li>If unresolved, contact PhoneHub support</li>
